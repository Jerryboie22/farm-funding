  ...
  <div className="mx-auto grid max-w-[1632px] grid-cols-1 lg:grid-cols-[49.2%_50.8%]">
    ...
    <div className="flex items-center justify-center pl-[8px] pr-[28px] py-[18px]">
            ...
            {RELATED_ARTICLES.map((article) => (
              ...
              >
                ...
                <div className="pt-[28px]">
                  <Link
                    href={article.href}
                    className="font-display text-[21px] font-[700] leading-[1.3] text-[#5a4400]"
                  >
                    {article.title}
                    <span className="ml-[4px] text-[18px]">
                      ›
                    </span>
                  </Link>
                </div>

                <p className="pt-[28px] text-[12px] font-[700] uppercase tracking-[0.4px] text-[#686868]">
                  {article.date}
                </p>
              </article>
            ))}
      ...
      <section className="w-full bg-[#4f832a] text-white">
        <div className="mx-auto flex max-w-[1550px] flex-col items-center px-[40px] py-[60px] text-center">

          <h2 className="font-display m-0 text-[40px] font-[800] leading-[1.25] text-white">
            Sign up for our Today&apos;s Harvest Blog.
          </h2>

          <p className="m-0 mt-[16px] text-[18px] leading-[28.8px] text-white">
          ...
          <form className="mt-[30px] flex w-full max-w-[520px] gap-[12px]">
            ...
            <button
              type="submit"
              className="rounded-[4px] border-2 border-white bg-[#4f832a] px-[18px] py-[10px] text-[16px] font-[700] leading-[20px] text-white"
            >
              Sign Up
            </button>
          </form>
