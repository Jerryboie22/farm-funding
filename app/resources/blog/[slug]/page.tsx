    ...
    <main className="w-full bg-white text-[#231f20]">
      <section className="w-full bg-white">
        <div className="mx-auto w-full max-w-[1180px] px-[24px] pt-[48px] md:px-[32px] md:pt-[62px] lg:pt-[72px]">
          ...
          <Link href={BLOG_PATH} className="mt-[16px] inline-block text-[15px] leading-[24px] font-bold text-[#496d83] hover:underline" style={{ fontFamily: "Montserrat-Bold" }}>
            {article.category}
          </Link>
          <h1 className="mt-[10px] max-w-[1080px] text-[38px] leading-[45px] text-[#4f832a] md:text-[48px] md:leading-[56px] lg:text-[52px] lg:leading-[60px]" style={{ fontFamily: "Montserrat-Bold" }}>
            {article.title}
          </h1>
      ...
      <section className="w-full bg-white">
        <div className="mx-auto w-full max-w-[1180px] px-[24px] pt-[34px] md:px-[32px] md:pt-[42px]">
          <img src={article.image} alt={article.title} className="block h-[270px] w-full object-cover md:h-[430px] lg:h-[520px]" />
        </div>
      </section>
      ...
      <section className="w-full bg-white">
        <div className="mx-auto w-full max-w-[980px] px-[24px] py-[42px] md:px-[32px] md:py-[58px] lg:py-[66px]">
          ...
          <div className="mt-[42px] md:mt-[50px]">
            {article.sections.map((section, index) => (
              <section key={`${section.heading}-${index}`} className="mb-[38px] md:mb-[46px]">
                <h2 className="text-[27px] leading-[34px] text-[#4f832a] md:text-[32px] md:leading-[40px]" style={{ fontFamily: "Montserrat-Bold" }}>
                  {section.heading}
                </h2>
          ...
          <div className="mt-[38px] flex items-start gap-[18px] border-t border-[#e2e2e2] pt-[28px]">
            ...
            <div>
              <p className="text-[20px] leading-[28px] text-[#4f832a]" style={{ fontFamily: "Montserrat-Bold" }}>{article.author}</p>
              <p className="mt-[3px] text-[16px] leading-[25px] text-[#666]" style={{ fontFamily: "Barlow-Medium" }}>Farm Funders</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-[#f4f4f2]">
        <div className="mx-auto w-full max-w-[1180px] px-[24px] py-[52px] md:px-[32px] md:py-[68px]">
          <h2 className="text-[30px] leading-[38px] text-[#4f832a] md:text-[38px] md:leading-[46px]" style={{ fontFamily: "Montserrat-Bold" }}>You Might Also Like</h2>
      ...
      <section className="w-full bg-[#4f832a] px-[24px] py-[58px] text-center text-white md:py-[72px]">
        <div className="mx-auto max-w-[760px]">
          <h2 className="text-[30px] leading-[38px] text-white md:text-[38px] md:leading-[46px]" style={{ fontFamily: "Montserrat-Bold" }}>Meet the Authors</h2>
          ...
          <Link href="/contact" className="mt-[28px] inline-flex rounded-[4px] border-2 border-white bg-transparent px-[20px] py-[10px] text-[16px] font-bold text-white hover:bg-white hover:text-[#4f832a]" style={{ fontFamily: "Montserrat-Bold" }}>Meet the Authors</Link>
        </div>
      </section>

      <section className="w-full bg-[#ecf1e4] px-[24px] py-[48px] md:py-[60px]">
        <div className="mx-auto max-w-[680px] text-center">
          <h2 className="text-[26px] leading-[34px] text-[#4f832a] md:text-[32px]" style={{ fontFamily: "Montserrat-Bold" }}>Sign up for our Today&apos;s Harvest Blog.</h2>
          <p className="mt-[14px] text-[17px] leading-[28px] text-[#231f20]" style={{ fontFamily: "Barlow-Medium" }}>Get the latest blog articles delivered to your inbox.</p>
