...
export const CURRENT_REFERENCE_ARTICLES: HarvestArticle[] = [
  ...
  },
  {
    ...
    excerpt:
      "Farm Credit East has been alerted to a rise in fraud attempts involving criminals impersonating trusted financial institutions, including Farm Credit System institutions and CoBank, Farm Credit East's funding bank.",
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "How to open an account", body: "The election can be made using Form 4547 with a parent's or guardian's tax return or through the online process at trumpaccounts.gov. Families should review the applicable rules and contribution requirements before making an election." },
    ],
  },
  {
