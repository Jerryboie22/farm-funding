...
export default function GoToAssistPage() {
  return <ReferenceContentPage title="Go To Assist" intro="Go To Assist connects agricultural producers with practical resources, tools and information to help them move their business forward." image="/images/homepage/tractor-field.jpg" sections={[
