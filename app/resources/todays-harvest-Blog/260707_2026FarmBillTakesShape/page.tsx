      ...
      <article className="mx-auto w-full max-w-[850px] px-6 pb-14 pt-10 sm:px-8 md:px-10 md:pt-12 lg:px-0 lg:pt-14">
        ...
        >
          <p>
            ...
            Boozman (AR) released the <em>Agricultural Act of 2026</em>, a
            &ldquo;discussion draft&rdquo; providing the Senate a starting
            point for negotiation with other committee members.
          </p>

          <p className="mt-6">
            While the two proposals differ in several areas, they share broad
            agreement on many of agriculture&rsquo;s priorities. Both bills
            would strengthen the farm safety net, invest in conservation,
            modernize USDA credit programs and expand support for specialty
            crops through fiscal year 2031. Perhaps more notable than what the
            Senate proposal includes is what it leaves out. Unlike the House
            bill, the Senate draft largely avoids the most politically
            divisive provisions, instead focusing on areas where bipartisan
            consensus already exists. This is driven by the necessity to
            garner 60 votes on the Senate floor, a much different political
            environment than in the House. The differences in policy and
            politics could prove significant as lawmakers work toward a final
          ...
          <p className="mt-6">
            ...
            transparency and reporting. This is likely an effort to bring more
            oversight into CCC spending and use of CCC funds by the executive
            branch.
          </p>
          ...
          <p>
            Conservation represents another area of general agreement between
            both chambers. There are no substantial changes to the following
            conservation programs in either proposal:
          </p>
          ...
          <p className="mt-6">
            The two proposals diverge primarily in implementation. The Senate
            bill places greater emphasis on expanding the Conservation Reserve
            Enhancement Program (CREP), strengthening technical assistance,
            updating conservation practice standards, and improving
            administrative flexibility for USDA conservation programs.
          </p>

          <p className="mt-6">
            The House proposal focuses more directly on conservation outcomes,
            adding new soil health initiatives, flood vulnerability research,
            winter wheat environmental studies, and mitigation banking
            authorities.
          </p>
          ...
          <p>
            Credit title provisions are among the least controversial sections
            of both bills and have provided critical updates for the Farm
            Credit System. The following breakdown highlights the Farm Credit
            priorities that were included in the House and Senate proposals
            and where they vary.
          </p>
          ...
          <ul className="mt-4 list-disc space-y-2 pl-6">
            ...
            <li>
              <strong>H.R. 1063</strong>, which would confirm the role of the
              Farm Credit Administration (FCA) as the Farm Credit System&rsquo;s
              sole regulator and require the collection of certain loan
              applicants&rsquo; demographic information in a way that protects
              their privacy.
            </li>
            ...
            <li>
              ...
              an important tool for Farm Credit lenders working with beginning
          ...
          <ul className="mt-4 list-disc space-y-2 pl-6">
            ...
            <li>
              ...
              simplifies the application process for real estate and operating
              loans up to $1 million, requiring the Secretary to notify
              lenders of approval or disapproval within five business days.
            </li>
          </ul>
          ...
          <ul className="mt-4 list-disc space-y-2 pl-6">
            ...
            <li>
              Clarifying CoBank&rsquo;s renewable and waste authority to lower
              operational and energy costs for customers
            </li>
          ...
          <p className="mt-6">
            The Senate proposal expands organic certification cost-share, food
            safety education, bio-stimulant regulation, biotechnology policy
            coordination, and agricultural quarantine inspection funding.
          </p>
          ...
          <p>
            ...
            proposals. Both bills strengthen premium assistance for beginning
            farmers, improve Whole-Farm Revenue Protection, expand quality
            loss adjustment coverage, continue investments in research and
            development, update reimbursement rates, and reinforce program
            integrity.
          </p>
          ...
          <p className="mt-6">
            Although the core producer titles are similar, a stark divergence
            between the two bills are several high-profile political issues
            that are completely omitted from the Senate proposal.
          </p>
          ...
          <ul className="mt-4 list-disc space-y-2 pl-6">
            ...
            <li>
              <em>California Proposition 12</em> — The House includes language
              addressing livestock production standards associated with
              Proposition 12. The Senate proposal omits those provisions.
            </li>
          ...
          <p className="mt-6">
            These issues are among the most politically contentious components
            of the House bill and are expected to be points of contention if
            Congress proceeds to conference.
          </p>
          ...
          <p>
            ...
            far more common ground than previous farm bill debates. Both seek
            to strengthen the farm safety net, preserve conservation
          ...
          <p className="mt-6">
            The principal differences lie less in agricultural policy than in
            broader political priorities, particularly those around the
            ...
            rates. Beginning in FY 2028, states with error rates above 6% must
            pay between five and 15% of SNAP benefit costs, a departure from
            the program&rsquo;s previous structure where benefits were fully
            funded by the federal government. The OBBB Act also shifted
            administrative costs to the states by an additional 25% beginning
            in FY 2027. Critics of this program&rsquo;s changes are asking for
            a one-year extension, pushing the administrative cost shift until
            FY28 – allowing all states an additional year to adjust budgets.
          </p>

          <p className="mt-6">
            As we await a markup from the Senate Agriculture Committee, the
            challenge ahead will be preserving the bipartisan consensus around
            core farm programs while resolving the broader policy issues.
            It&rsquo;s this bipartisan consensus (or lack thereof) that has
            historically made completing a farm bill one of Congress&rsquo;s
            most difficult legislative undertakings.
          </p>
        </div>
        ...
        <div className="mt-10 border-t border-charcoal/10 pt-6">
          ...
          {TAGS.map((tag, index) => (
            <span key={tag}>
              <Link
                href={`${BLOG_PATH}?tag=${encodeURIComponent(tag)}`}
        ...
        <div className="mt-8 flex items-center gap-4 border-t border-charcoal/10 pt-6">
          <div
            className="flex h-[68px] w-[68px] shrink-0 items-center justify-center rounded-full bg-cream font-display text-[20px] font-bold text-forest"
            aria-hidden="true"
          >
            DC
          </div>
