...
const REPORTS = [
  {
    ...
    href: "https://www.farmcrediteast.com/en/resources/Industry-Trends-and-Outlooks/Reports/2607KEP_H2AForDairyEmployers",
    excerpt:
  ...
  },
  {
    ...
    date: "July 10, 2026",
    image: "/images/homepage/Dairy cows milking.jpg",
    href: "https://www.farmcrediteast.com/DFS",
    excerpt:
      "Farm Credit East's annual dairy farm summary reviews the financial performance of Northeast dairy operations and provides an outlook for the remainder of 2026.",
  },
  {
    ...
    href: "https://www.farmcrediteast.com/en/resources/Industry-Trends-and-Outlooks/Reports/2606KEP_FuelFertilizerandConflictinMiddleEast",
    excerpt:
  ...
  },
  {
    ...
    date: "May 3, 2026",
    image: "/images/homepage/Dairy cows milking.jpg",
    href: "https://www.farmcrediteast.com/en/resources/Industry-Trends-and-Outlooks/Reports/2605KEP_DairyMidYearTrends",
    excerpt:
    ...
    <main className="w-full bg-white">
      <section className="w-full bg-[#ecf1e4]">
        <div className="mx-auto max-w-[1440px] px-[4.05%] py-[55px] md:py-[70px] lg:py-[85px]">
          <h1
            className="font-display text-[34px] leading-[1.15] text-[#4f832a] md:text-[44px] lg:text-[50px]"
          >
          ...
          <p className="mt-[22px] max-w-[900px] text-[17px] leading-[1.75] text-[#231f20] md:text-[19px] md:leading-[1.7]">
            Discover insights, trends, ag market outlooks and other topical
            information as it relates to the Northeast&apos;s diverse
            agricultural industries. Brought to you by Knowledge Exchange from
            Farm Funding.
          </p>
        </div>
      </section>
      ...
      <section className="w-full bg-white">
        <div className="mx-auto max-w-[1440px] px-[4.05%] py-[55px] md:py-[70px] lg:py-[85px]">
          ...
          <div className="mt-[35px] grid grid-cols-1 gap-[35px] md:grid-cols-2">
            {REPORTS.map((report) => (
              <article key={report.title} className="bg-white">
                <a href={report.href} target="_blank" rel="noreferrer" className="group block">
          ...
          <div className="mt-[55px] border-t border-[#d4d8d0] pt-[35px]">
            <Link
              href="/"
              className="inline-flex h-[51px] items-center justify-center rounded-[4px] border-2 border-[#496d83] bg-[#496d83] px-[22px] text-[16px] font-bold text-white transition-colors hover:bg-white hover:text-[#496d83]"
            >
              ← Back to Home
            </Link>
          </div>
